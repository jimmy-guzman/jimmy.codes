...
On top of that, maintenance can become a headache due to the fragile nature. Lastly, it doesn't encourage good accessibility practices, as there's no direct link between what's tracked and what users see.
