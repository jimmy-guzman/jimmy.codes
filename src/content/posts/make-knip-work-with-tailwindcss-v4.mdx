...
[Knip](https://knip.dev) helps declutter JavaScript and TypeScript projects by detecting dead exports, unused files, and dependencies. It does this intelligently using a plugin system modeled after real-world tooling and frameworks. This fine-grained approach results in an accurate representation of dead code. Out of the box, Knip technically works with Tailwind CSS v4 — but not perfectly. Its lack of support for Tailwind’s new **@plugin** and **@import** directives can cause false positives.
