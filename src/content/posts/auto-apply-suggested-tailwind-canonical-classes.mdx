...
It does other stuff too like [upgrading between Tailwind versions](https://tailwindcss.com/docs/upgrade-guide#using-the-upgrade-tool), but were benefiting from the canonical class conversion here.
