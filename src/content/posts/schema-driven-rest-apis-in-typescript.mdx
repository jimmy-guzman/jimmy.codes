...
tags: [TypeScript, Backend, Node.js]
---
...
The table describes how data is stored. Not how callers interact with it. Imports throughout this guide use a `@/*` path alias pointing to `src/`.
...
IDs use [TypeID](https://github.com/jetify-com/typeid-js): `typeid("post")` produces `post_01h2xcejqtf2nbrexx3vqjhp41`. Type-prefixed and sortable.
