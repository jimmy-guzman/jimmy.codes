...
I wanted a faster and more reliable process, so I built an automated solution using **Node.js** and [**Sharp**](https://sharp.pixelplumbing.com). It splits each scan into two clean frames and optimizes their dimensions to preserve quality. Along the way, I learned more than expected about signal processing, image geometry, and compression.
