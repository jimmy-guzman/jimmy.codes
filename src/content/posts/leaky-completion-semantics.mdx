...
If you find yourself checking conditions before calling a function, question the boundary.

If a function returns special values to signal a “wrong path,” question the routing.

If callers need internal rules to use it safely, the abstraction leaked.

Everything is an API.  
Even code you're “just supposed to know.”
