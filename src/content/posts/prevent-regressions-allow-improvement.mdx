...
I even gave a [lightning talk at Target](https://slides.com/comparto/deck-910a4f/scroll?chrome=hidden) about it.
...
- It avoids extension systems and custom checks by design
...
All credit goes to the original idea from Betterer, which inspired this simpler implementation. Feedback and contributions are always welcome.
