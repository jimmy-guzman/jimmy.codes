...
The match threshold sits at 0.4, well below the usual 0.75. That embedding model scores lower than you'd expect: a recall query that should clearly match landed at 0.61.
